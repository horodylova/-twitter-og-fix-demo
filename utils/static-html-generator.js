...
class StaticHTMLGenerator {
  ...
  buildHTML(data) {
    ...
    const safeImageUrl = this.escapeHtml(data.imageUrl);
    const safePageUrl = this.escapeHtml(data.pageUrl);
...
<body>
<div class="container">
  <div class="badge">✅ Dynamic Content</div>
  <h1>${safeTitle}</h1>
  <img src="${safeImageUrl}" alt="${safeTitle}" class="hero-image">
  <p class="description">${safeDescription}</p>
  <div class="meta-info">
    <strong>Page URL:</strong> ${safePageUrl}<br>
    <strong>Image URL:</strong> ${safeImageUrl}<br>
